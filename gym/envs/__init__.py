...
for draw_tiles in range(2):
    ...
    register(
        ...
        entry_point='gym.envs.' + '{}_gym_super_mario:MetaSuperMarioBrosEnv'.format(USERNAME),
    ...
    for (world_number, level_number, area_number, max_distance) in SMB_LEVELS:
        ...
        register(
            ...
            entry_point='gym.envs.' + '{}_gym_super_mario:SuperMarioBrosEnv'.format(USERNAME),
            max_episode_steps=10000,
