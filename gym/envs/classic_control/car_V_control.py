...
class CarEnv(gym.Env):
    ...
    def step(self, action):
        ...
        action_pre = np.array([action_pre[0], 0.])
    ...
    def reset(self):
        ...
        self.state[1] = 0.#self.np_random.uniform(low=-np.pi/10, high=np.pi/10, size=(1,))
